...
int64 QuantileEstimator::ComputeK() {
...
// void QuantileEstimator::Flush(string* output) {
//   SzlEncoder enc;
...
// void QuantileEstimator::FlushForDisplay(vector<string>* output) {
//   output->clear();
//   if (tot_elems_ == 0) {
//     output->push_back("");
//     return;
...
// bool QuantileEstimator::EncodingToString(SzlDecoder *const dec,
//                                         string *const output) {
...
// SzlTabEntry::MergeStatus QuantileEstimator::SzlQuantileEntry::Merge(
//                                       const string& val) {
